...
export default class MouseController {
    ...
    static async store(req: Request, res: Response) {
        ...
        if (funcionario.mouse) {
            return res.status(400).json({ error: 'O funcionário já possui um Mouse principal associado' });
        }
    ...
    static async update(req: Request, res: Response) {
        ...
        if (!funcionario.mouse) {
            return res.status(400).json({ error: 'O funcionário não possui um Mouse principal associado' });
        }
